...
class _GuardianAndVipStoreScreenState extends State<GuardianAndVipStoreScreen>
  ...
  var privilegesUrlsDisable = [
    "assets/images/ic_privilege1.png",
    "assets/images/ic_privilege2.png",
    "assets/images/ic_privilege3.png",
    "assets/images/ic_privilege4.png",
    "assets/images/ic_privilege5.png",
    "assets/images/ic_privilege6.png",
    "assets/images/ic_privilege7.png",
    "assets/images/ic_privilege8.png",
    "assets/images/ic_privilege9.png",
    "assets/images/ic_privilege10.png",
    "assets/images/ic_privilege11.png",
    "assets/images/ic_privilege12.png",
    "assets/images/ic_privilege13.png",
    "assets/images/ic_privilege14.png",
    "assets/images/ic_privilege15.png",
    "assets/images/ic_privilege16.png",
    "assets/images/ic_privilege17.png",
    "assets/images/ic_privilege18.png",
    "assets/images/ic_privilege19.png",
    "assets/images/ic_privilege20.png",
  ];

  var privilegesUrlsUnable = [
                                ...
                                IntrinsicWidth(
                                  child: IntrinsicHeight(
                                    child: ContainerCorner(
                                      ...
                                      child: TextWithTap(
                                        index == 0
                                            ? "guardian_and_vip_screen.current_level"
                                                .tr()
                                            : "guardian_and_vip_screen.not_gained"
                                                .tr(),
                                        fontSize: 12,
                                        color: Colors.white,
                                        marginLeft: 17,
  ...
  String listMembersPrivileges(int index) {
    ...
    return privilegesUrlsUnable[index];
  }
