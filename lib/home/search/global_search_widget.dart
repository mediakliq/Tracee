    ...
    builder: (BuildContext context) {
      return StatefulBuilder(builder: (context, newState) {
        ...
        searchUser() async {
          ...
          query.whereNotEqualTo(UserModel.keyUid, currentUser.getUid!);
          query.setLimit(1);
          ParseResponse response = await query.query();
          newState(() {
            if (response.success) {
              searching = false;
              if (response.results != null) {
                searchedUser = response.results!.first;
              } else {
                noResult = true;
              }
            } else {
                    ...
                    child: Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: "search_live_by_title".tr(),
                          hintStyle: TextStyle(
                            fontWeight: FontWeight.w100,
                            color: Colors.black,
                            fontSize: 15,
