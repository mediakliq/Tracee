...
class QuickHelp {
  ...
  static String getUserPersonalizedCard(String levelCode) {
    if (levelCode == "VIP1") {
      return "assets/images/vip_bg_cover_1.png";
    } else if (levelCode == "VIP2") {
      return "assets/images/vip_bg_cover_2.png";
    } else if (levelCode == "VIP3") {
      return "assets/images/vip_bg_cover_3.png";
    } else if (levelCode == "VIP4") {
      return "assets/images/vip_bg_cover_4.png";
    } else if (levelCode == "VIP5") {
      return "assets/images/vip_bg_cover_5.png";
    } else if (levelCode == "VIP6") {
      return "assets/images/vip_bg_cover_6.png";
    } else if (levelCode == "VIP7") {
      return "assets/images/vip_bg_cover_7.png";
    } else if (levelCode == "VIP8") {
      return "assets/images/vip_bg_cover_8.png";
    } else if (levelCode == "VIP9") {
      return "assets/images/vip_bg_cover_9.png";
    } else if (levelCode == "VIP10") {
      return "assets/images/vip_bg_cover_10.png";
    } else {
      return "";
    }
  }
